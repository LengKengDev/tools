        ...
        <div id="accordion">
                    ...
                    <div class="card-body">
                        <ul>
                            ...
                            <li>Đăng ký tham gia Slack channel bằng tài khoản @sun-asterisk.com tại
                                <a href="https://join.slack.com/t/jobcanautobot/signup">https://join.slack.com/t/jobcanautobot/signup</a>
                            </li>
                            <li>Sau khi có tài khoản slack thì bắt đầu liên kết bằng cách bấm vào đây để thêm Jobcan vào slack:
                                <a href="https://slack.com/oauth/authorize?scope=commands&amp;client_id=3164932209.141855791831"><img src="https://platform.slack-edge.com/img/add_to_slack.png" srcset="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" alt="Add to Slack" width="139" height="40"><br><br></a></li>
            ...
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                        <ul>
                            <li>Truy cập đường dẫn <a href="https://api.slack.com/custom-integrations/legacy-tokens">https://api.slack.com/custom-integrations/legacy-tokens</a></li>
