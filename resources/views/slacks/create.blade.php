                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('slacks.store') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="email" type="text" class="form-control{{ $errors->has('token') ? ' is-invalid' : '' }}" name="token" value="{{ old('token') }}" required autofocus  placeholder="e.g. xoxp-xxxxxxxxxxxxx">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 pt-2">
                                    <div class="row">
                                        <div class="col-12">
                                            <input id="email" type="radio" class="{{ $errors->has('workspace') ? ' is-invalid' : '' }}" name="workspace" value="1" {{ old('workspace') == 1 ? 'checked' : '' }}> もうJobcan Autobotを参加した。<a
                                                    href="https://join.slack.com/t/jobcanautobot/signup"><i class="fa fa-fw fa-slack"></i>Workspaceのリンク</a>
                                        </div>
                                        <div class="col-12">
                                            <input id="email" type="radio" class="{{ $errors->has('workspace') ? ' is-invalid' : '' }}" name="workspace" value="0" {{ old('workspace') == 0 ? 'checked' : '' }}> まだJobcan Autobotを参加しないが、その他のWorkspaceを参加している。
